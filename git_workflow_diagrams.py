...
origin_color = '#c8e6c9'
clone_color = '#ffe0b2'
will_color = '#f3e5f5'  # light purple for Case 3


def case1_quick_fixes():
    """Case 1: Quick fixes - PR goes directly to upstream/dev"""
...
def case2_feature_branch():
    """Case 2: Major feature development - PR goes to feature branch"""
    fig, ax = plt.subplots(1, 1, figsize=(12, 8))
    ax.set_xlim(0, 12)
    ax.set_ylim(0, 8)
    ax.set_aspect('equal')
...
def case3_fork_to_fork():
    """Case 3: Contributing to someone's fork - PR goes to their fork"""
